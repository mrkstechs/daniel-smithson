...
<div id="home">
    ...
    <section class="img_txt">
        <div class="img-wrap">
            <img src="<?php echo esc_attr( get_option( 'first_image' ) ); ?>" alt="Daniel Smithson, session drummer for hire in London" />
        </div>
        <div class="txt-wrap">
            <span><?php echo esc_attr( get_option( 'prof_text_one' ) ); ?></span>
        </div>
    </section>
    <section class="img_txt">
        <div class="box">
            <p><?php echo esc_attr( get_option( 'text_one' ) ); ?></p>
        </div>
        <div class="img-wrap">
            <img src="<?php echo esc_attr( get_option( 'second_image' ) ); ?>" alt="Daniel Smithson,  drum tutor in London" />
        </div>
    </section>
    <section class="img_txt">
        <div class="txt-wrap">
            <span><?php echo esc_attr( get_option( 'prof_text_two' ) ); ?></span>
        </div>
        <div class="img-wrap">
            <img src="<?php echo esc_attr( get_option( 'third_image' ) ); ?>" alt="live band for hire in London" />
        </div>
    </section>
    <section class="txt2">
        <div class="box">
            <p><?php echo esc_attr( get_option( 'text_two' ) ); ?></p>
        </div>
        <div class="feeback">
            <?php
                $query = new WP_Query( array(
                    'category_name' => 'feeback',
				    'post_per_page' => 1
                ));
                if($query->have_posts()){
                    while($query->have_posts()){
    ...
    <?php
        echo do_shortcode('[contact-form-7 id="5" title="booking form"]');
    ?>
</div>
</main>
<?php
